...
DATA_DIR = "data/hospitals/client3"
...
def load_data():
    ...
    for label, cls in enumerate(["normal", "diseased"]):
        ...
        print(f"Loading {len(images)} {cls} images from client3...")
...
def train():
    print("Client3 Training Started...")
    model = create_model()
    X, y = load_data()
    ...
    os.makedirs("clients/client3", exist_ok=True)
    model.save("clients/client3/local_model.h5")
    print("Client3 training done. Model saved to clients/client3/local_model.h5")
