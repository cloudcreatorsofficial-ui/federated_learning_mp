...
DATA_DIR = "data/hospitals/client1"
...
def load_data():
    ...
    for label, cls in enumerate(["normal", "diseased"]):
        ...
        print(f"Loading {len(images)} {cls} images from client1...")
...
def train():
    ...
    os.makedirs("clients/client1", exist_ok=True)
    model.save("clients/client1/local_model.h5")
    print("Client1 training done. Model saved to clients/client1/local_model.h5")
